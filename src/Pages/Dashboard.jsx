...
function Dashboard() {
  ...
  <div className='grid grid-cols-1 md:grid-cols-2 gap-5'>
    ...
    <div className='bg-gray-200/40 px-5 py-5 my-5 rounded-md shadow-sm hover:shadow-blue-600 hover:scale-95 hover:-translate-y-3 duration-300'>
        <div className='flex justify-between'>
          ...
          <button onClick={()=> navigate ('/revenuereport')} className='px-3 py-1 bg-gray-200 rounded-md hover:text-blue-600 hover:scale-95 duration-300'>View Report</button>
        </div>
  ...
  <div className='flex gap-5 mt-4'>
    ...
    <div className='bg-gray-200/40 px-5 py-5 my-5 rounded-md shadow-sm hover:shadow-blue-600 hover:scale-95 hover:-translate-y-3 duration-300'>
      <div className='flex justify-between'>
        ...
        <button onClick={()=> navigate ('/ordertimereport')} className='px-3 py-1 bg-gray-200 rounded-md hover:text-blue-600 hover:scale-95 duration-300'>View Report</button>
      </div>
  ...
  bg-[conic-gradient(#5A6ACF_0deg_100deg,#F59E0B_100deg_240deg,#10B981_240deg_360deg)]">
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 gap-5  '>
        ...
        <button onClick={()=> navigate ('/ourrating')} className='px-3 py-1 bg-gray-200 rounded-md hover:text-blue-600 hover:scale-95 duration-300'>View Report</button>
      </div>
  ...
  bg-[conic-gradient(#2FBFDE_320deg,#f59e0b_72deg,transparent_300deg,transparent_360deg)]">
        ...
        <div className='bg-gray-200/40 px-5 py-5 mt-5 rounded-md shadow-sm hover:shadow-blue-600 hover:scale-95 hover:-translate-y-3 duration-300'>
            <div className='flex justify-between'>
              ...
              <button onClick={()=> navigate ('/mostorderreport')} className='px-3 py-1 bg-gray-200 rounded-md hover:text-blue-600 hover:scale-95 duration-300'>View Report</button>
            </div>
            <p>2.568</p>
