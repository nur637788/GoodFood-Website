...
const FoodOrder = () => {
  ...
  const [search, setSearch] = useState(""); // ✅ এখানে value change করা যাবে
  ...
  return (
    <div id='up' className="min-h-screen bg-white text-black relative">
      ...
      <a className='font-bold z-50 right-0 bg-amber-300 px-2 rounded-sm fixed bottom-2' href="#up">↑</a>
    </div>
  );
}
