       ...
       <div className='space-y-7 flex-1 w-full h-screen px-2 md:px-4 py-3'>
        ...
        <nav className='flex flex-col items-start gap-2 space-y-1'>
            <p className={` md:block font-bold text-[10px] italic { ${open ? "hidden" : ""}`}>MENU</p>
                {/* Dashboard icon */}
            <NavLink to='/'><button className='flex gap-2 items-center hover:scale-110 hover:text-teal-500  duration-300'>
                ...
                {/* Food Order icon */}
            <NavLink to='/foodOrder'><button className='flex gap-2 items-center hover:scale-110 hover:text-teal-500  duration-300'>
                ...
                {/* Manage Menu icon */}
            <NavLink to='/manageMenu'><button className='flex gap-2 items-center hover:scale-110 hover:text-teal-500  duration-300'>
            ...
            <NavLink to='/customerReview'><button className='flex gap-2 items-center hover:scale-110 hover:text-teal-500  duration-300'>
        ...
        <nav className='flex flex-col items-start gap-2 space-y-1'>
            <p className={` md:block font-bold text-[10px] italic { ${open ? "hidden" : ""}`}>OTHERS</p>
                {/* Setting menu */}
            <NavLink to='/settings'><button className='flex gap-2 items-center hover:scale-110 hover:text-teal-500  duration-300'>
                ...
                {/* Payment menu */}
            <NavLink to='/payment'><button className='flex gap-2 items-center hover:scale-110 hover:text-teal-500  duration-300'>
                ...
                {/* Accounts menu */}
            <NavLink to='/accounts'><button className='flex gap-2 items-center hover:scale-110 hover:text-teal-500  duration-300'>
                ...
                {/* Help Menu */}
            <NavLink to='/help'><button className='flex gap-2 items-center hover:scale-110 hover:text-teal-500  duration-300'>
